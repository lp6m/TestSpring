...
public class HingeStencil {
    ...
    public HingeStencil(Vector3 x0, Vector3 x1, Vector3 x2, Vector3 x3) {
        ...
        f0 = -1 * n / h0;
        f1 = cos_alpha2 / h1 * n + cos_alpha2dash / h1dash * ndash;
        f2 = cos_alpha1 / h2 * n + cos_alpha1dash / h2dash * ndash;
        f3 = -1 * ndash / h0dash;
